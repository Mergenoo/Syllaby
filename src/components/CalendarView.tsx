    ...
    <div className="bg-white border border-black rounded-lg shadow-sm p-6">
      ...
      {selectedEvent && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white border border-black rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <span className="font-medium w-20 text-black">Type:</span>
                <span
                  className={`px-2 py-1 rounded text-sm ${
                    selectedEvent.event_type === "assignment"
                      ? "bg-blue-100 text-blue-800 border border-blue-200"
                      : selectedEvent.event_type === "exam"
                      ? "bg-red-100 text-red-800 border border-red-200"
                      : selectedEvent.event_type === "reading"
                      ? "bg-green-100 text-green-800 border border-green-200"
                      : selectedEvent.event_type === "google_calendar"
              ...
              <div className="flex items-center">
                <span className="font-medium w-20 text-black">Date:</span>
                <span className="text-black">
                  {formatDate(selectedEvent.due_date)}
                </span>
              </div>

              {selectedEvent.due_time && (
                <div className="flex items-center">
                  <span className="font-medium w-20 text-black">Time:</span>
                  <span className="text-black">
                    {formatTime(selectedEvent.due_time)}
                  </span>
                </div>
              )}
              ...
              <div className="flex items-center">
                <span className="font-medium w-20 text-black">Source:</span>
